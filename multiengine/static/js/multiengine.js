...
function MultiEngineXBlock(runtime, element) {
    ...
    */
    ...
    studentScript.text = 'function script_'+uniqueId+'(){var element = document.querySelector(\'[data-usage-id="'+data_usage_id+'"]\');' +scenarioJSON.javascriptStudent+'};function script_'+uniqueId+'()';
